...
<Tabs
  groupId="pureness"
  defaultValue="declarative"
  values={[
    { label: 'Declarative way', value: 'declarative', },
    { label: 'Imperative way', value: 'imperative', },
  ]
}>
<TabItem value="declarative">
...
[Try it in Playground](https://share.effector.dev/it0gXQLI)
...
[Try it in Playground](https://share.effector.dev/D5hV8C70)
...
[store.map](./api/effector/Store.md#mapfn-state-state-laststate-t--t)  
[forward](./api/effector/forward.md)  
[store.watch](./api/effector/Store.md#watchwatcher)  
